const recipe = [
    ...
    },
    {
        ...
        UserId:1,
        CategoryId:1,
        Img:"https://cdn.getmood.io/warehouse/dynamic/423306.jpg",
        Duration:120,
        Difficulty:2,
        Description:"עוגת גבינה אפויה ביתית על עוגיות חמאה בציפוי עדין של שוקולד מריר",
        Ingrident:[
            {Name:"ביסקביטים",Count:200,Type:"גר'"},
    ...
    },
    {
        ...
        Ingrident:[
            {Name:"חצי אבטיח בינוני-גדול חתוך לקוביות",Count:0,Type:"-"},
            {Name:"מיץ תפוזים",Count:0.5,Type:"כוס"},
            {Name:"- לא חובה תלוי במתיקות האבטיח -אבקת סוכר",Count:1.2,Type:"כפות"}
        ],
        Instructions:[
